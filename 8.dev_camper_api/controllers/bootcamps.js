...
exports.updateBootcamp = asyncHandler(async(req,res,next) => {
        ...
        if(bootcamp.user.toString() !== req.user.id && req.user.role !== 'admin'){
                return  next(
                        new ErrorResponse(`Usere ${req.params.id} is  not authorized to update this bootcamp`, 401)
                        )
        }
...
exports.deleteBootcamp = asyncHandler(async(req,res,next) => {
        ...
        if(bootcamp.user.toString() !== req.user.id && req.user.role !== 'admin'){
                return  next(
                        new ErrorResponse(`Usere ${req.params.id} is  not authorized to delete this bootcamp`, 401)
                        )
        }
